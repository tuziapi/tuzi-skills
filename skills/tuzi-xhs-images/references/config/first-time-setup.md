...
description: First-time setup flow for tuzi-xhs-images preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.tuzi-skills/tuzi-xhs-images/EXTEND.md` | Current project |
| User | `~/.tuzi-skills/tuzi-xhs-images/EXTEND.md` | All projects |
