...
Structure for user preferences in `.tuzi-skills/tuzi-slide-deck/EXTEND.md`.
...
Then use with: `/tuzi-slide-deck content.md --style style-name`
...
1. `.tuzi-skills/tuzi-slide-deck/EXTEND.md` (project)
2. `$HOME/.tuzi-skills/tuzi-slide-deck/EXTEND.md` (user)
