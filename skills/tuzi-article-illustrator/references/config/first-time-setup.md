...
description: First-time setup flow for tuzi-article-illustrator preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.tuzi-skills/tuzi-article-illustrator/EXTEND.md` | Current project |
| User | `~/.tuzi-skills/tuzi-article-illustrator/EXTEND.md` | All projects |
