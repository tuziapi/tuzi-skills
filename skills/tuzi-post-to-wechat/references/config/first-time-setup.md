...
description: First-time setup flow for tuzi-post-to-wechat preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.tuzi-skills/tuzi-post-to-wechat/EXTEND.md` | Current project |
| User | `~/.tuzi-skills/tuzi-post-to-wechat/EXTEND.md` | All projects |
