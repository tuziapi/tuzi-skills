...
test -f .tuzi-skills/tuzi-comic/EXTEND.md && echo "project"

# Then user-level (cross-platform: $HOME works on macOS/Linux/WSL)
test -f "$HOME/.tuzi-skills/tuzi-comic/EXTEND.md" && echo "user"
```

| Path | Location |
|------|----------|
| `.tuzi-skills/tuzi-comic/EXTEND.md` | Project directory |
| `$HOME/.tuzi-skills/tuzi-comic/EXTEND.md` | User home |
...
**Strategy A: Using `--ref` parameter** (e.g., tuzi-image-gen)
