...
```bash
/tuzi-comic content.md --storyboard-only
```
...
```bash
/tuzi-comic content.md --prompts-only
```
...
```bash
/tuzi-comic comic/topic-slug/ --images-only
```
...
```bash
# Single page
/tuzi-comic comic/topic-slug/ --regenerate 3

# Multiple pages
/tuzi-comic comic/topic-slug/ --regenerate 2,5,8

# Cover page
/tuzi-comic comic/topic-slug/ --regenerate 0
```
