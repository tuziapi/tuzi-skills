...
description: First-time setup flow for tuzi-comic preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.tuzi-skills/tuzi-comic/EXTEND.md` | Current project |
| User | `~/.tuzi-skills/tuzi-comic/EXTEND.md` | All projects |
