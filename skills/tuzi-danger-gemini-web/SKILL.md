...
- macOS: `~/Library/Application Support/tuzi-skills/gemini-web/consent.json`
- Linux: `~/.local/share/tuzi-skills/gemini-web/consent.json`
- Windows: `%APPDATA%\tuzi-skills\gemini-web\consent.json`
