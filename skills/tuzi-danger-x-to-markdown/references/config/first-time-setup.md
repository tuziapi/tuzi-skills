...
description: First-time setup flow for tuzi-danger-x-to-markdown preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.tuzi-skills/tuzi-danger-x-to-markdown/EXTEND.md` | All projects |
| Project | `.tuzi-skills/tuzi-danger-x-to-markdown/EXTEND.md` | Current project |
