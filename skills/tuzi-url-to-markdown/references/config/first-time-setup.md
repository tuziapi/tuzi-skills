...
description: First-time setup flow for tuzi-url-to-markdown preferences
---
...
| Choice | Path | Scope |
|--------|------|-------|
| User | `~/.tuzi-skills/tuzi-url-to-markdown/EXTEND.md` | All projects |
| Project | `.tuzi-skills/tuzi-url-to-markdown/EXTEND.md` | Current project |
